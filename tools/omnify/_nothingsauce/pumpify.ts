//https://github.com/mafintosh/pumpify/blob/master/index.js
import { Duplexify } from "./duplexify"
import { pump } from "./pump"

class Pumpify extends Duplexify {
  constructor(...streams) {
    super(null, null, { autoDestroy: false, destroy: false, objectMode: true, highWaterMark: 16 })
...
function pumpify(...streams) {
  return new Pumpify(...streams)
}

export { pumpify }

//original incase something breaks
